...
class CompleteFeatureGroupJobDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CompleteFeatureGroupJobDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param job_output_details:
            The value to assign to the job_output_details property of this CompleteFeatureGroupJobDetails.
    ...
    def job_output_details(self):
        """
        Gets the job_output_details of this CompleteFeatureGroupJobDetails.

        :return: The job_output_details of this CompleteFeatureGroupJobDetails.
    ...
    def job_output_details(self, job_output_details):
        """
        Sets the job_output_details of this CompleteFeatureGroupJobDetails.

        :param job_output_details: The job_output_details of this CompleteFeatureGroupJobDetails.
