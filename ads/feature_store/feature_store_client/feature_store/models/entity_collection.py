...
class EntityCollection(object):
    """
    Results of a Entity search. Contains EntitySummary data.
    """
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.feature_store.models.EntitySummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this EntityCollection.
        List of featureStore Entity.


        :return: The items of this EntityCollection.
        :rtype: list[oci.feature_store.models.EntitySummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.feature_store.models.EntitySummary]
        """
        self._items = items
