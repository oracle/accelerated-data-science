        ...
        .with_storage_mount(
          {
            ...
            "dest" : "<destination_directory_name_one>"
          }, # mount OCI File Storage Service for Jobs
          {
            "src" : "oci://<bucket>@<namespace>/<prefix>",
            "dest" : "<destination_directory_name_two>"
          } # mount OCI Object Storage Service for Jobs
        )
    )
