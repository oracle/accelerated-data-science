...
class TestDataTypePandasObject(FeatureStoreTestCase):
    ...
    data1 = Decimal("1.23")
    data2 = Decimal("3.45")
    df_decimal = pd.DataFrame({"A": pd.Series(data1),
                               "B": pd.Series(data2)})
    ...
    def test_feature_group_pandas_object_string_infer_schema(self):
        ...
        feature_group = self.define_feature_group_resource_with_pandas_object_string_infer_schema(
    ...
    def test_feature_group_pandas_object_string_with_schema(self):
        ...
        feature_group = self.define_feature_group_resource_with_pandas_object_string_with_schema(
            entity.oci_fs_entity.id, fs.oci_fs.id
        )
    ...
    def test_feature_group_pandas_object_decimal_infer_schema(self):
        ...
        feature_group = self.define_feature_group_resource_with_pandas_object_decimal_infer_schema(
            entity.oci_fs_entity.id, fs.oci_fs.id
        )
        feature_group.create()
    ...
    def test_feature_group_pandas_object_decimal_with_schema(self):
        ...
        feature_group = self.define_feature_group_resource_with_pandas_object_decimal_with_schema(
            entity.oci_fs_entity.id, fs.oci_fs.id
        )
    ...
    def test_feature_group_pandas_object_date_infer_schema(self):
        ...
        feature_group = self.define_feature_group_resource_with_pandas_object_date_infer_schema(
            entity.oci_fs_entity.id, fs.oci_fs.id
        )
        feature_group.create()
    ...
    def test_feature_group_pandas_object_date_with_schema(self):
        ...
        feature_group = self.define_feature_group_resource_with_pandas_object_date_with_schema(
            entity.oci_fs_entity.id, fs.oci_fs.id
        )
