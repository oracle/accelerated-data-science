...
class TestPipelineMLStep(PipelineTestCase):
    def test_pipeline_with_ml_steps(self):
        ...
        try:
            ...
            self.assert_pipeline_run(pipeline, pipeline_run, "ML_JOB")
    ...
    def test_cancel_pipeline_with_ml_steps(self):
        pipeline = self.define_pipeline_with_ml_steps()
