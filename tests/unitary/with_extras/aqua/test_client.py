...
class TestExtendedRequestError:
    """Unit tests for ExtendedRequestError."""
    ...
    def test_exception_attributes(self):
        ...
        exception = ExtendedRequestError(message, original_exception, response_text)
...
class TestShouldRetryException:
    ...
    def test_http_status_error_in_force_list(self):
        ...
        exception = ExtendedRequestError("Message", original_exception, "Response text")
...
class TestRetryDecorator:
    ...
    def test_retry_decorator_exceeds_retries(self):
        ...
        test_instance = TestClass()
        with pytest.raises(ExtendedRequestError):
...
class TestClient:
    ...
    def test_request_http_error(self):
        """Ensures that _request raises ExtendedRequestError on HTTP error."""
        payload = {"prompt": "Hello"}
        response_mock = Mock()
        response_mock.status_code = 500
        ...
        with pytest.raises(ExtendedRequestError) as exc_info:
